...
<video style="display:block; max-width:100%; height:auto;" src="webm/03-progressive/distraction.webm" controls loop="loop" preload></video><br>
...
You could consider not placing the doors then and try to destroy the blocks from a distance where knights wouldn't be able to slash you, like in the gif below.

<video style="display:block; max-width:100%; height:auto;" src="webm/03-progressive/slashflag2.webm" controls loop="loop" preload></video><br>
