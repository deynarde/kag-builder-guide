...
When you use a water bucket on someone with a lit keg, they also drop the keg if they were holding it, which gives you some time to pick it up.
...
- Overheated drills emit light, so you can sometimes spot tunneling rats with drills.
...
<video style="display:block; max-width:100%; height:auto;" src="webm/01-basics/sawgif1.webm" controls loop="loop" preload></video><br>
...
<video style="display:block; max-width:100%; height:auto;" src="https://www.youtube.com/embed/gYyuslQfGtE" controls loop="loop" preload></video><br>
