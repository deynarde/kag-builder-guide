...
- 1x1 size in inventory.
- Builders (but not knights and archers) can use a drill by holding left mouse button while you have one in your hand. It destroys blocks much more quicker than if you were destroying them using pickaxe. The drill also destroys 2 blocks in front of the drill. 
