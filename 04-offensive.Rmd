...
This is a pretty good tower -- it's not worth trying to go to the top with your team because there's way too many doors, and even if you managed to get there you can't do much damage. It's also not that easy to collapse. Howver, there's an obvious weakness -- the bottom is very sparsely protected and has no doors. What I would do is make some defenses for myself at the bottom (stone or wooden blocks + doors -- yellow and dark blue colours), then drill through (the arrow) and then quickly block all the enemy doors with stone blocks (light blue colour) then drill into the flag. 
...
If you're being attacked by several enemies at once, you can catch an enemy bomb and suicide with it and kill some enemy builders.
