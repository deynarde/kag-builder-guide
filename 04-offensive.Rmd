...
Some builders sometimes decide to use platforms facing upwards. This can provide some defense from enemy knights jumping down (as well as from spikes if you place two platforms for each time) and lets your knights climb the tower as well, but keep in mind that platforms are easily destroyable by enemy knights as well as that climbing them is slower than climbing ladders. Moreover, placing platforms is slightly slower than solid stone or wood blocks. This isn't a very good tactic -- using ladders or stone blocks is more effective.
...
Another way to win the 1v1 is to heal yourself -- eat a burger, a fish or use a heart to heal yourself after losing some health.
